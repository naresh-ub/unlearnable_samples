...
def main():
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if (
                        ...
                        save_path = os.path.join(
                            args.output_dir, f"saved_images_{global_step}"
                        )
    ...
    if accelerator.is_main_process:
        ...
        #     print("Saving full model is ", save_full_model)
        # else:
        #     save_full_model = args.save_as_full_pipeline
        #     print("Saving full model 2 is ", save_full_model)
